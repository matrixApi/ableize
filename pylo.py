...
class pyCore:
    ...
    #         i = dict.__new__(i) # XXXX calls dict.__init__ with the __new__ arguments, which DEFEATS THE FUCKING POINT
    ...
    class PythonScriptElement:
        ...
        def open(self, type, content, **attributes):
            # Nested elements.
            if type == 'text/python':
                return pyCore.PythonScriptElement(self, content, **attributes)
    ...
    class synchronization:
        ...
        class network:
            ...
            class messager:
                ...
                def __call__(self, *args, **kwd):
                    ...
                    except Exception, e: result = (False, e)
                    else: result = (True, e)
        ...
        class web(network):
            ...
            def init(self, address, port, **kwd):
                from SimpleXMLRPCServer import SimpleXMLRPCServer as XMLRPC
...
def load(api):
    ...
    # return pyCore(bindingsLoad(api))
